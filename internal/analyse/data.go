...
type VenueStats struct {
	...
	FrequencyFirstToScore *float64 `json:"frequency_first_to_score,omitempty"`
	FrequencyGoal20       *float64 `json:"frequency_goal_20,omitempty"`
	FrequencyGoal45       *float64 `json:"frequency_goal_45,omitempty"`
	FrequencyGoal70       *float64 `json:"frequency_goal_70,omitempty"`
}
